...
A version of the contract stripped of comments to make a point about cryptoeconomic design 
and simplicty.
Anybody should be able to curate whatever information they are interested in
using only some fixed, fungible constant - like TOTAL SNT - and ~80 lines of code.
