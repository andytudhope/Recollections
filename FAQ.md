...
**I think in terms of the staking by the app creators, this can be done via the Harberger tax. In terms of the up votes and down votes, this can be done via voice credits that are generated by the staking and activated using QV so that people can express intensity of up votes and down votes by showing with real stake.**
